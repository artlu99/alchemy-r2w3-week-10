  ...
  return (
    <header className="top-0 text-xs">
      <p className="float-right">
        ...
        &nbsp;my original&nbsp; 
        <a href="https://docs.alchemy.com/docs/how-to-create-a-decentralized-twitter-with-lens-protocol" target="_blank" rel="noopener noreferrer">Week 10</a>&nbsp;
        ...
        <a href="https://docs.alchemy.com/docs/welcome-to-the-road-to-web3" target="_blank" rel="noopener noreferrer">Road to Web3</a>
      </p>
      <p> &nbsp; </p>
  ...
  return (
    <footer className="sticky bottom-0">
      ...
      <p className="float-right">
        ...
        <a href="https://twitter.com/artlu99" target="_blank" rel="noopener noreferrer">@artlu99</a>
      </p>
